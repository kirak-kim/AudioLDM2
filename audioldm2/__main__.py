...
parser.add_argument(
	...
	required=False,
	default=0.5,
	help="(style_transfer) Strength of text-guided transfer. 0 keeps the source, 1 follows the text.",
)
...
parser.add_argument(
    ...
    required=False,
    default="generation",
    help="{generation,sr_inpainting,style_transfer} generation: text-to-audio generation; sr_inpainting: super resolution inpainting; style_transfer: text-guided audio-to-audio",
    choices=["generation", "sr_inpainting", "style_transfer"]
)
